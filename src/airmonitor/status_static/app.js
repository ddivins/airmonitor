...
function renderSession() {
  ...
  if (!session.authenticated || !user) {
    ...
    panel.innerHTML = `<a class="grafana-signin" href="/grafana/login?redirectTo=%2F">Sign in <span aria-hidden="true">→</span><small>Administration and dashboards</small></a><a class="password-reset" href="/grafana/user/password/send-reset-email">Forgot password?</a>`;
